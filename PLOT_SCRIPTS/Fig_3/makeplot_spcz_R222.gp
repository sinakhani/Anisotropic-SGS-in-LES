...
set output 'fig3_d.tex' # filename for output
...
set label '(d)' at 1.25,9e-8  # write text '(d)'

plot  '/scratch/m/mwaite/sinakh/LES_Hor_DNS_Ver/DNS/R222N4.2/Cont_to_15/spczavg.dat'                    using ($1*2):($2/2)     title 'D22N4'             lt 1 lc 9 lw 5,\
      '/scratch/m/mwaite/sinakh/LES_Hor_DNS_Ver/LES/R222N4.2/Cont_to_10/spczavg.dat'                    using ($1*2):($2/2)     title 'LA22N4a'             lt 2 lc 3 lw 5,\
      '/scratch/m/mwaite/sinakh/LES_Hor_DNS_Ver/LES/R222N4.2_b/Cont_to_10/spczavg.dat'                  using ($1*2):($2/2)     title 'LA22N4b'             lt 5 lc 4 lw 5,\
      '/scratch/m/mwaite/sinakh/LES_Hor_DNS_Ver/LES_CLSSC/R222N4.2_mv/Cont_to_15/spczavg.dat'           using ($1*2):($2/2)     title 'LC22N4a'              lt 2 lc 5 lw 5
